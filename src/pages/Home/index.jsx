  ...
  return (
    <div className="home">
      ...
      <div className="section3">
        ...
        <div className="content">
          ...
          <p>
            ...
            <b> assistant in the raising of broiler chickens</b>, moving through
            the sheds to{" "}
      ...
      <div className="section5">
        <h2>Validation</h2>
        <img src={validationMobile} alt="Validation graphics" />
      </div>
        ...
        <div className="text">
          <div className="column">
            <p className="first">
              ...
              improved feed conversion and meat quality to potentially reducing
              mortality.
            </p>
            <p>
